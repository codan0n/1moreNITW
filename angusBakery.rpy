...
label angusBakeryCoffee:
    ...
    if tgFailsafe = True:
        ...
        angus "Can do."
        angus "Would you like me to heat up that roll for you?"
        ...
        angus "Haha that snow came out of nowhere, didn't it? My winter coat hasn't even fully grown in yet!"
        
        menu:
            "I like the cold.":
                player "I like the cold."

                angus "I do too, but I'd say I'm better equipped to handle it than most."
            "I hate the cold.":
                player "I hate the cold."

                angus "I don't mind it but it makes me sleepy."
            "The cold doesn't bother me.":
                player "The cold doesn't bother me."

                angus "Well that's good, cause I have a feeling we're in for a loooong winter."
            
        angus "A warm treat on a cold day is really quite comfy though."
        ...
        "You exit the store, warming your hands on the coffee cup."
        
    
    
    elif metBea == True and metAngus == True:
        #visited bakery before talking to bea
        $ tgInvite = True
        ...
        #on coffee quest, this is your first time visiting bakery
        $ tgInvite = True
        $ metAngus = True
